...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { nombre: @proyecto.nombre, responsable: @proyecto.responsable, url_githu: @proyecto.url_githu } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { nombre: @proyecto.nombre, responsable: @proyecto.responsable, url_githu: @proyecto.url_githu } }
